...
| 步骤 6 / 闸门 A2（核心 SF/BP） | E02 BP 正式 + E03 SF 正式（5 个划分对照，accuracy_pct 统一）；附未训练/多数类诊断基线 | ✅ 2026-09-23：BP 86.88±0.98（论文 86.84±1.0，+0.04 pp）、SF 88.11±1.22（论文 87.95±1.4，+0.16 pp），均判定"与论文一致"；诊断基线未单列（可选，不阻塞） |
